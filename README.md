...
6. Instalar y ejecutar los contenedores usando 'docker-compose up' en la carpeta raíz del proyecto; alternativamente, usar 'docker-compose up -d' si no se necesita ver los logs  
